...
public class MutationState implements SQLCloseable {
    ...
    private void send(Iterator<TableRef> tableRefIterator) throws SQLException {
        ...
        TraceScope trace = Tracing.startNewSpan(connection, "");
        ...
        while (tableRefIterator.hasNext()) {
            ...
            while (mutationsIterator.hasNext()) {
                ...
                String tableName = Bytes.toString(htableName);
                Span child = null;
                if (tableName.equalsIgnoreCase(QueryServicesOptions.DEFAULT_TRACING_STATS_TABLE_NAME)) {
                    child = Tracing.child(span, "Writing mutation batch for table: " + tableName);
                }
